...
namespace ChatApi.Migrations
{
    ...
    [Migration("20200819223417_nullableMascota")]
    partial class nullableMascota
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatApi.Models.NotificacionCabecera", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NotificacionCabecera");
                });

            modelBuilder.Entity("ChatApi.Models.NotificacionDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ChatApi.Models.NotificacionDetalle", b =>
                {
                    b.HasOne("ChatApi.Models.NotificacionCabecera", "Cabecera")
                        .WithMany("Detalle")
                        .HasForeignKey("CabeceraId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ChatApi.Models.Usuarios", "Cliente")
                        .WithMany()
